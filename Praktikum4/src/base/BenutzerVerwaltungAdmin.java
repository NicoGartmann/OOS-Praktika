 ...
 * 					einzutragen und ggf. auch zu l�schen.</p>
 * @author nicog
 * @version 2.0
 */
public class BenutzerVerwaltungAdmin implements BenutzerVerwaltung, Serializable {
	...
	/**
	 * <p>benutzerEintragen tr�gt einen neuen Benutzer in die Datenhaltung ein</p>
	 * @param Benutzer
	 * @return void
	...
	/**
	 * <p>benutzerOK pr�ft lediglich, ob der Benutzer benutzer bereits in der Datenhaltung vorhanden
	 * ist </p>
	 * @param Benutzer
	 * @return boolean
	 */
